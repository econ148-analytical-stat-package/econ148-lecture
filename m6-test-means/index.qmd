...
## working directory
setwd("D:/Githu-repository/econ148-analytical-stat-packages/econ148-lecture/m6-test-means")
...
3. Test the assumptions and Identify the 
appropriate test.
...
Using the **mpg** dataset, test whether there is 
a statistically significant difference in the hwy miles per 
gallon (hwy) between 4-cylinder and 8-cylinder 
automobiles.
...
t.test(score ~ time, data = training_data, paired = TRUE, na.rm = TRUE)
```
:::
